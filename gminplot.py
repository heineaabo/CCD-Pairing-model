...
plt.plot(x,np.abs(E08-CI_E_g1),label=r'$\alpha=0.8$')
plt.legend()
...
#plt.semilogy(x,t02,label=r'$\alpha=0.2$')
plt.semilogy(x,t04,label=r'$\alpha=0.4$')
plt.semilogy(x,t06,label=r'$\alpha=0.6$')
plt.semilogy(x,t08,label=r'$\alpha=0.8$')
